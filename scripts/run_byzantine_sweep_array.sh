...
RESULTS_ROOT="${RESULTS_ROOT:-$PROJECT_DIR/results_reviewer/byzantine_sweep}"
...
DATASETS=(pathmnist organamnist organsmnist)
ATTACKS=(label_flip sign_flip scaling random_update gaussian_model_poisoning)
...
echo "Scenario $TASK_ID/${#SCENARIOS[@]}: dataset=$DATASET attack=$ATTACK_TYPE ratio=$MALICIOUS_RATIO seed=$SEED"
